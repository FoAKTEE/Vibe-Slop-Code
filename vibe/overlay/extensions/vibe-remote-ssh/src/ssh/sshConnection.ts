...
import { Client, ClientChannel, ClientErrorExtensions, ExecOptions, ShellOptions, ConnectConfig, SFTPWrapper } from 'ssh2'; // vibe: SFTPWrapper
...
export default class SSHConnection extends EventEmitter {
    ...
    // vibe: a SFTP session over this connection, the upload install mode sends the server through it
