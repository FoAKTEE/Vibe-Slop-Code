...
// compiler installed, every project of this extension must also pass it: the extension-host project (model, host),
// the webview project (view, DOM) and the tests.
for (const project of ['tsconfig.json', 'src/view/tsconfig.json', 'test/tsconfig.json']) {
